...
public class AdminController {
	...
	public String loginJson(HttpServletRequest req,HttpSession session, Users users) {
		String sessionCode = (String) session.getAttribute("code");// session中验证码
		String sessionCode1= (String)req.getSession().getAttribute("code");
		
		System.out.println("取出来的00>>>"+sessionCode+"，id为>>"+session.getId());
		System.out.println("iiiii>>>>>"+sessionCode1);
